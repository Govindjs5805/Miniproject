...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="legal-container">
      <style>{`
        .legal-container { padding: 120px 20px; background: #0a0a1a; color: #cbd5e1; line-height: 1.6; }
        .legal-box { max-width: 800px; margin: 0 auto; background: rgba(255,255,255,0.02); padding: 40px; border-radius: 20px; border: 1px solid rgba(255,255,255,0.05); position: relative; }
